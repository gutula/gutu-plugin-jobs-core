...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/jobs-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-jobs-core:");
...
console.log("Documentation check passed for gutu-plugin-jobs-core.");
