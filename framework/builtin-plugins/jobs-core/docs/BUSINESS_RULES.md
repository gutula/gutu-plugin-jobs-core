# Jobs Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `jobs-core` and its owned resource set.
...
- This plugin currently exports 1 action(s), 1 resource(s), 13 job definition(s), and 0 workflow definition(s).
